...
def calculate_nearest_hub(G, user_location):
    ...
    for name, hub_node in hub_nodes.items():
        try:
            distance_meters = nx.bellman_ford_path_length(G, user_node, hub_node, weight='length')
...
def plot_route(G, user_location, nearest_hub_name, nearest_distance_km, distances_km):
    ...
    m.save("shortest_route_map_blf.html")
...
def main():
    ...
    plot_route(G, user_location, nearest_hub_name, nearest_distance_km, distances_km)

    save_to_csv(user_location, nearest_hub_name, nearest_distance_km)

    import webbrowser
    webbrowser.open("shortest_route_map_blf.html")
